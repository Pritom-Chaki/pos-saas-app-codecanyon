...
class _PurchasePremiumPlanScreenState extends State<PurchasePremiumPlanScreen> {
  ...
  SubscriptionRequestModel subscriptionRequestModelData =
                            ...
                            onTap: () async {
                              if (selectedPlan.subscriptionName == '') {
                                ...
                                await userProfileDetails.when(data: (details) {
                                  EasyLoading.dismiss();
                                  subscriptionRequestModelData.countryName =
                                      details.countryName ?? '';
                                  subscriptionRequestModelData.language =
                                      details.language ?? '';
                                  subscriptionRequestModelData.pictureUrl =
                                      details.pictureUrl ?? '';
                                  subscriptionRequestModelData.companyName =
                                      details.companyName ?? '';
                                  subscriptionRequestModelData
                                          .businessCategory =
                                      details.businessCategory ?? '';
                                  subscriptionRequestModelData.phoneNumber =
                                      details.phoneNumber ?? '';
                                }, error:
                                ...
                                final flutterBkash = FlutterBkash(
                                    bkashCredentials: BkashCredentials(
                                        ...
                                        isSandbox: false));
                                try {
                                  double price = ((selectedPlan.offerPrice < 1)
                                  ...
                                  final result = await flutterBkash.pay(
                                    ...
                                    merchantInvoiceNumber:
                                        subscriptionRequestModelData.userId,
                                  );

                                  if (result != null) {
                                    // EasyLoading.dismiss();
                                    String? sellerUserRef =
                                        await getSaleID(id: await getUserID());
                                    if (sellerUserRef != null) {
                                          ...
                                          FirebaseDatabase.instance
                                              ...
                                              .child(
                                                  subscriptionRequestModelData
                                                      .userId)
                                              .child('Subscription');
                                      selectedPlan.subscriptionDate =
                                          DateTime.now().toString();
                                      await subscriptionRef
                                          .set(selectedPlan.toJson());
                                      ...
                                      subscriptionRequestModelData
                                          .transactionNumber = result.trxId;
...
*/
                            ...
                            child: Container(
                              ...
                              Subscript.customersActivePlan.subscriptionName !=
                                  selectedPlan.subscriptionName),
                        ],
                      ),
                    ),
