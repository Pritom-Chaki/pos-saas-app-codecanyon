...
class PrinterPurchase extends ChangeNotifier {
  ...
  Future<bool> printTicket({required PrintPurchaseTransactionModel printTransactionModel, required List<ProductModel>? productList, required bool printer58}) async {
