...
class GeneratePdf {
  Future<void> generatePurchaseDocument(PurchaseTransactionModel transactions, PersonalInformationModel personalInformation, BuildContext context, {required bool share}) async {
